...
START_NAMESPACE_DISTRHO
    ...
    void GraphWidget::onNanoDisplay() override
    {
        flipY();
    ...
    bool GraphWidget::onScroll(const ScrollEvent &ev) override
    {
    ...
    bool GraphWidget::onMouse(const MouseEvent &ev) override
    {
        switch (ev.button)
        {
        case 1:
    ...
    bool GraphWidget::onMotion(const MotionEvent &ev) override
    {
