...
public:
	...
	{
        this->filtertype = (int)std::round(value);
	}
	...
	inline float process(const float input, float cutoff, float resonance) 
	{
		...
		return decimator2->Calc(decimated1, decimated2);
	}
};
#endif
