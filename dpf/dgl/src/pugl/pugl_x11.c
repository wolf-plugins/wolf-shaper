...
int puglCreateWindow(PuglView *view, const char *title)
{
	PuglInternals *const impl = view->impl;
	...
	Atom mwmHintsProperty = XInternAtom(impl->display, "_MOTIF_WM_HINTS", 0);
	struct MwmHints hints;
	hints.flags = MWM_HINTS_DECORATIONS;
	hints.decorations = 0;
	XChangeProperty(impl->display, impl->win, mwmHintsProperty, mwmHintsProperty, 32,
...
void puglShowWindow(PuglView *view)
{
	XMapRaised(view->impl->display, view->impl->win);
}

void puglHideWindow(PuglView *view)
{
...
void puglPostRedisplay(PuglView *view)
{
	view->redisplay = true;
}
